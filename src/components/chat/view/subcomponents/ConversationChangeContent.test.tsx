...
import { calculateDiff, type DiffCalculator } from '../../utils/messageTransforms';

import ConversationChangeContent from './ConversationChangeContent';
import ConversationChangesBar from './ConversationChangesBar';

const i18n = createInstance();
await i18n.init({ lng: 'en', resources: { en: { chat: enChat } }, interpolation: { escapeValue: false } });
