...
import { ActionMenu, Button, Dialog, DialogContent, Input, LLMProviderLogo } from '@/shared/ui';
...
/** Used by the sidebar module to browse and manage cross-project conversation groups. */
export default function SidebarConversationGroups({
  ...
  // Keep the active group management dialog independent from paginated rows.
