...
import { useClaudeSessionActions } from '@/modules/chat/session-actions/ClaudeSessionActionsContext';

/** Used by chat transcript rows to open side-chat and rewind actions for saved Claude messages. */
export default function MessageSessionActions({ message }: { message: ChatMessage }) {
  ...
  const items: ComponentProps<typeof ActionMenu>['items'] = [{
